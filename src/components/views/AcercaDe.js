      ...
      <section className="imagenFondo">
        ...
        <article className="articulo text-center container table-responsive">
          ...
          <p className="text-light">
            ...
            aprovechar lo que recibimos para convertirlo en algo mejor. Sobre
            todas las cosas, siempre queremos que la pases bien comiendo y
            bebiendo delicioso con nosotros. Descubre todo nuestro menú
            sorprendiéndote con algo nuevo cada vez.
          </p>
        </article>
      </section>
          ...
          <Row xs={1} sm={2} md={4} className="g-4 py-5">
            <Col>
              <Card className="nosotrosCard">
                ...
                <Card.Body className="bg-dark">
                  <Card.Link
                    href="https://github.com/franAndrad"
                    className="gris tipografiaCard"
                  >
                    Andrade Francisco
                  </Card.Link>
                </Card.Body>
            ...
            <Col>
              <Card className="nosotrosCard">
                ...
                <Card.Body className="bg-dark">
                  <Card.Link
                    href="https://github.com/nicolasandr"
                    className="gris tipografiaCard"
                  >
                    Andrade Nicolas
                  </Card.Link>
            ...
            <Col>
              <Card className="nosotrosCard">
                ...
                <Card.Body className="bg-dark">
                  <Card.Link
                    href="https://github.com/MDanielaCardozo"
                    className="gris tipografiaCard"
                  >
                    Cardozo Daniela
                  </Card.Link>
            ...
            <Col>
              <Card className="nosotrosCard">
                ...
                <Card.Body className="bg-dark">
                  <Card.Link
                    href="https://github.com/carlosmsx"
                    className="gris tipografiaCard"
                  >
                    Escobar Carlos
                  </Card.Link>
          ...
          <Row xs={1} sm={2} md={4} className="g-4 pb-5">
            ...
            <Col>
              <Card className="nosotrosCard">
                ...
                <Card.Body className="bg-dark">
                  <Card.Link
                    href="https://github.com/OttoKrautmann"
                    className="gris tipografiaCard"
                  >
                    Krautmann Otto
                  </Card.Link>
            ...
            <Col>
              <Card className="nosotrosCard">
                ...
                <Card.Body className="bg-dark">
                  <Card.Link
                    href="https://github.com/JuanMeni"
                    className="gris tipografiaCard"
                  >
                    Menichetti Juan
                  </Card.Link>
            ...
            <Col>
              <Card className="nosotrosCard">
                ...
                <Card.Body className="bg-dark">
                  <Card.Link
                    href="https://github.com/valeormaechea"
                    className="gris tipografiaCard"
                  >
                    Ormaechea Valentina
                  </Card.Link>
